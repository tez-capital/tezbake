...
* [tezbake setup-tezsign](/tezbake/reference/cmd/tezbake_setup-tezsign)	 - Setup tezsign for baking.
...
* [tezbake tezsign](/tezbake/reference/cmd/tezbake_tezsign)	 - Passes args through to signer app - tezsign.
