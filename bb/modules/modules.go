...
type IAmiBasedModule interface {
	GetPath() string
}

func LoadAppDefinition(app IAmiBasedModule) (map[string]interface{}, string, error) {
...
func LoadAppConfiguration(app IAmiBasedModule) (map[string]interface{}, error) {
...
type BakeBuddyModuleDefinition struct {
	Id      string
	Control IBakeBuddyModuleControl
}
